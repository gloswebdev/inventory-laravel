...
<div class="space-y-8 pb-10">
    ...
    <div class="animate-in fade-in slide-in-from-bottom duration-700 delay-300">
        ...
        <div class="grid {{ count($modules) === 1 ? 'grid-cols-1' : 'grid-cols-2' }} gap-4">
            ...
            @if(empty($modules))
            <div class="col-span-2 glass-premium p-10 rounded-[2.5rem] text-center border-dashed border-2 border-slate-200">
                <div class="w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="fas fa-lock text-slate-300 text-2xl"></i>
                </div>
                <p class="text-[9px] text-slate-400 uppercase font-black px-4 tracking-widest">No mobile modules assigned yet.</p>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="animate-in fade-in slide-in-from-bottom duration-700 delay-500">
        <h3 class="text-slate-800 font-900 uppercase tracking-[0.15em] text-[10px] mb-5 px-2 italic">
            <i class="fas fa-chart-pie text-indigo-500"></i> System Intelligence
        </h3>
        ...
        <div class="space-y-4">
            ...
            <div class="glass-premium p-6 rounded-[2.5rem] border border-white/80">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="text-[9px] font-black text-slate-800 uppercase tracking-tight">Last Batch Activity</div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="glass-premium p-5 rounded-[2.5rem] border border-white/80 flex items-center gap-3">
                    <div class="w-10 h-10 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-400">
                        <i class="fas fa-location-dot"></i>
                    </div>
                    <div>
                        <div class="text-sm font-900 text-slate-800">{{ count($stats['permitted_branches']) }}</div>
                        <div class="text-[7px] font-black text-slate-400 uppercase tracking-widest">Locations</div>
                    </div>
                </div>
                <div class="glass-premium p-5 rounded-[2.5rem] border border-white/80 flex items-center gap-3">
                    <div class="w-10 h-10 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-400">
                    ...
                    <div>
                        <div class="text-sm font-900 text-slate-800">{{ $stats['pending_indents'] }}</div>
                        <div class="text-[7px] font-black text-slate-400 uppercase tracking-widest">Pending Task</div>
                    </div>
                </div>
            </div>
        </div>
