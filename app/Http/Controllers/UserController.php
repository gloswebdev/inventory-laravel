...
class UserController extends Controller
{
    ...
    protected $modules = [
        ...
        'agent_targets' => 'Agent Targets Manager',
        ...
        'mobile_agent_targets' => 'Mobile: Agent Targets',
    ...
    protected $moduleFeatures = [
        ...
        'mobile_collection' => [
            ...
            'month_filter'          => 'Month Selector Filter',
            'date_filter'           => 'From / To Date Filter',
            'branch_filter'         => 'Group / Branch Filtering',
            'agent_filter'          => 'Agent Selection Filter',
            'zero_collection_filter' => 'Hide Zero Collection Filter',
            'team_filter'           => 'Team Selector Buttons',
        ],
        'mobile_teams_setup' => [
            'view'   => 'View Teams Hierarchy',
            'create' => 'Create New Teams',
            'edit'   => 'Configure & Edit Teams',
            'delete' => 'Delete Teams',
        ],
        'mobile_agent_targets' => [
